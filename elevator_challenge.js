{
    init: function(elevators, floors) {
        ...
        for(var i=0; i<floors.length; i++)
			(function(floor){
				...
				floor.on("down_button_pressed", function(){
                    ...
                    queueToNearestElevator(this.floorNum(), false);

	            });

				floor.on("up_button_pressed", function(){

                    queueToNearestElevator(this.floorNum(), true);
        ...
        for(var i=0; i<elevators.length; i++)
        	(function(elevator){
        	    ...
        	    elevator.floorVisited = function(floor){
					...
					var index = elevator.destinationQueue.indexOf(floor);
					if(index > -1){
                ...
                elevator.rearrangeQueue = function(){
                    ...
                    if(destinationDistance == 0)
                        ...
                        nearestFloor = getNearestFloor(curfloor, elevator.destinationQueue, isGoingUp);
        ...
        var queueToNearestElevator = function(floorNum, isUp){

            var request = { floor: floorNum, isUp: isUp };
			
			var elevator = getNearestElevator(request);
			if(elevator != null)
			{
        ...
        var getNearestFloor = function(curFloor, queue, isGoingUp) {
		...
		var getNearestElevator = function(request) {
